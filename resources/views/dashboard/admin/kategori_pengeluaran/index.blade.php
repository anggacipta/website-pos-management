                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('kategori-pengeluaran.store') }}" method="post">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Kategori Pengeluaran</label>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach ($kategoris as $kategori)
                    <tr>
                        ...
                        <td>
                            @if ($kategori->id !== 1) <!-- Check if not default category -->
                            <a href="{{ route('kategori-pengeluaran.edit', $kategori->id) }}" class=""><i class="ti ti-edit h2 text-warning"></i></a>
                            <form action="{{ route('kategori-pengeluaran.destroy', $kategori->id) }}" method="post" class="d-inline delete-form">
                                @csrf
                                @method('delete')
