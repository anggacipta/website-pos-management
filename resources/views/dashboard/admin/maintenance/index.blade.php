    ...
    <div class="container-fluid">
        <div class="card-body">
            <div>
                ...
                <!-- Medium -->
                <!-- ------------------------------------------ -->
                <button class="btn me-1 mb-4 bg-primary text-white px-4 fs-4 " style="float: right"
                            ...
                            <div class="modal-body">
                                <form action="{{ route('kondisi-barang.store') }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="kondisi_barang" class="form-control" id="nama"
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach ($maintenances as $maint)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('maintenance.lanjutan', $maint->id) }}" class="btn btn-warning">Maintenance
                                Lanjutan</a>
                            <a href="{{ route('maintenance.rusak', $maint->id) }}" class="btn btn-danger">Rusak</a>
                            <form action="{{ route('maintenance.diperbaiki', $maint->id) }}" method="post"
                                  class="d-inline">
                                @csrf
                                @method('delete')
