...
CREATE TABLE IF NOT EXISTS `barangs` (
  ...
  `no_akl_akd` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `barangs_jenis_barang_id_foreign` (`jenis_barang_id`),
  KEY `barangs_merk_barang_id_foreign` (`merk_barang_id`),
  KEY `barangs_kondisi_barang_id_foreign` (`kondisi_barang_id`),
  KEY `barangs_sumber_pengadaan_id_foreign` (`sumber_pengadaan_id`),
  KEY `barangs_unit_kerja_id_foreign` (`unit_kerja_id`),
  CONSTRAINT `barangs_jenis_barang_id_foreign` FOREIGN KEY (`jenis_barang_id`) REFERENCES `jenis_barangs` (`id`),
  CONSTRAINT `barangs_kondisi_barang_id_foreign` FOREIGN KEY (`kondisi_barang_id`) REFERENCES `kondisi_barangs` (`id`),
  CONSTRAINT `barangs_merk_barang_id_foreign` FOREIGN KEY (`merk_barang_id`) REFERENCES `merk_barangs` (`id`),
  CONSTRAINT `barangs_sumber_pengadaan_id_foreign` FOREIGN KEY (`sumber_pengadaan_id`) REFERENCES `sumber_pengadaans` (`id`),
  CONSTRAINT `barangs_unit_kerja_id_foreign` FOREIGN KEY (`unit_kerja_id`) REFERENCES `unit_kerjas` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table website_inventaris.barangs: ~5 rows (approximately)
INSERT INTO `barangs` (`id`, `kode_barang`, `nama_barang`, `distributor`, `no_akl_akd`, `tahun_pengadaan`, `harga`, `keterangan`, `photo`, `jenis_barang_id`, `merk_barang_id`, `kondisi_barang_id`, `sumber_pengadaan_id`, `unit_kerja_id`, `created_at`, `updated_at`) VALUES
	(1, 'AKL00901', 'Coba Barang', 'PT. Nusa Jaya', 'KD091310', '2024-07-23', 8000, 'Coba bolo2', '1721707645.png', 2, 2, 5, 2, 2, '2024-07-22 21:07:25', '2024-07-25 20:01:29'),
	(2, 'BRG001', 'Coba Barang', NULL, NULL, '2024-07-23', 8000, NULL, '1721719487.png', 2, 2, 6, 2, 2, '2024-07-23 00:24:47', '2024-07-25 20:43:11'),
	(3, 'BRG002', 'Coba Barang3', NULL, NULL, '2024-07-12', 9000, NULL, '1721720259.png', 2, 2, 3, 2, 2, '2024-07-23 00:37:39', '2024-07-25 19:57:55'),
	(4, 'BRG000', 'Coba Barang3', NULL, NULL, '2024-07-23', 10000, NULL, '1721720297.png', 2, 2, 3, 2, 3, '2024-07-23 00:38:17', '2024-07-23 00:38:17');
...
INSERT INTO `jenis_barangs` (`id`, `jenis_barang`, `created_at`, `updated_at`) VALUES
	(2, 'Alat Kesehatan', '2024-07-22 19:27:45', '2024-07-22 19:27:45');
...
INSERT INTO `kondisi_barangs` (`id`, `kondisi_barang`, `created_at`, `updated_at`) VALUES
	(3, 'Rusak', '2024-07-22 20:06:33', '2024-07-22 20:06:33'),
...
INSERT INTO `merk_barangs` (`id`, `merk_barang`, `created_at`, `updated_at`) VALUES
	(2, 'Panasonic', '2024-07-22 19:28:56', '2024-07-22 19:28:56');
...
INSERT INTO `roles` (`id`, `name`, `created_at`, `updated_at`) VALUES
	(1, 'admin', '2024-07-22 02:28:33', '2024-07-22 02:28:35'),
...
CREATE TABLE IF NOT EXISTS `sumber_pengadaans` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `sumber_pengadaan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `sumber_pengadaans` (`id`, `sumber_pengadaan`, `created_at`, `updated_at`) VALUES
	(2, 'RSDH', '2024-07-22 20:06:45', '2024-07-22 20:06:45');
...
INSERT INTO `unit_kerjas` (`id`, `unit_kerja`, `created_at`, `updated_at`) VALUES
	(2, 'Administrasi', '2024-07-22 18:43:21', '2024-07-22 18:43:21'),
...
INSERT INTO `users` (`id`, `role_id`, `name`, `email`, `username`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Coba', 'admin@gmail.com', 'admin', NULL, '$2y$10$J/Q8TKSJrfEriYiL.S4hKu6o4Q8NVCmgM4eXXgw0wWjTSXnJPIaRe', NULL, '2024-07-21 19:31:02', '2024-07-21 19:31:02'),
	(3, 2, 'Coba Update', 'user@gmail.com', '', NULL, '$2y$10$GHN9japCsyHU2EuNcCEUXO2Vgnm7fAGHtKuft.zw7gbb5AGnvvrPO', NULL, '2024-07-21 20:10:32', '2024-07-21 20:10:32'),
	(5, 2, 'anggacipta', 'test@example.com', 'acna', NULL, '$2y$10$OQsb..SgP4BC7BhvZ2YVW.LADm.eavMO.IPDbZFlXae8LJlCeAzjW', NULL, '2024-07-24 00:00:53', '2024-07-24 00:00:53');
